...
public class Titles
{
    ...
    public List<Titles> GetTitles(int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            ...
            {
                connection.Open();
                string query = "Select * from Titles limit @limit offset @offset";
    ...
    public List<Titles> GetTitlesCollection(int pageSize, int offset)
    {
        ...
        using (MySqlConnection connection = new MySqlConnection(connectionString))
        {
            try
            {
                ...
                +"FROM titles t LEFT JOIN titles_gallery tg ON t.id = tg.title_id and tg.user_id = @userId limit @limit offset @offset";
                MySqlCommand command = new MySqlCommand(query, connection);
